...
Bezüglich der Sicherheit des Contracts Codes aus Abschnitt \ref{eth_smart_contract} gibt es 2 wichtige Angriffsfaktoren, die berücksichtigt werden müssen. Der Code der \code{payout} Funktion befindet sich zur Wiederholung am Ende der folgenden Seite.
