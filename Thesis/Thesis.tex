...
\degree{Information Systems Engineering} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\noindent Diese Ausarbeitung zeigt die Interaktion mit dem Bitcoin und Ethereum Netzwerk am Beispiel einer Glücksspielanwendung. Die Integration in die Anwendung erfolge im Falle von Bitcoin über einen Simple Payment Verification Node. Im Falle von Ethereum wird die Integration über einen Full (validating) Node demonstriert. Durch die Verwendung von Smart Contracts wird für diesen Anwendungsfall vollständig auf den Einsatz einer Trusted Third Party verzichtet. 
