...
Diese Ausarbeitung zeigt die Interaktion mit dem Bitcoin und Ethereum Netzwerk am Beispiel einer entwickelten Glücksspielanwendung. Durch die Verwendung eines Ethereum Smart Contracts wird gezeigt, dass man für diesen Anwendungsfall vollständig auf den Einsatz einer vertrauenswürdigen Drittpartei (Trusted Third Party) verzichten kann. Die Ausarbeitung veranschaulicht durch den direkten Vergleich von Bitcoin und Ethereum warum dies nicht durch den alleinigen Einsatz von Bitcoin möglich ist. 

Die Interaktion mit dem Bitcoin Peer-to-Peer Netzwerk wird als Simplified Payment Verification Node durch den Einsatz der BitcoinJ-Bibliothek demonstriert. Im Falle von Ethereum findet die Interaktion mit dem Peer-to-Peer Netzwerk über einen Full-Node statt. Dieser ist im Gegensatz zum SPV-Node dazu in der Lage alle Transaktionen eigenständig zu validieren. Die technische Umsetzung wird durch den Einsatz der Web3J-Bibliothek demonstriert.
...
\include{Chapters/btc_grundlagen} 
\include{Chapters/btc_konzept} 
\include{Chapters/btc_umsetzung} 
\include{Chapters/btc_evaluation} 


\include{Chapters/eth_grundlagen}
\include{Chapters/eth_konzept}  
\include{Chapters/eth_umsetzung}
\include{Chapters/eth_evaluation}
\include{Chapters/sonstiges}
...
\include{Appendices/gambling_sites}
